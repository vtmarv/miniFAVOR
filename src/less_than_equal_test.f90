...
contains
    ...
    pure function check_string_less_than_equal_string(strings) result(result_)
    ...
    pure function check_character_less_than_equal_string(strings) result(result_)
        use custom_generator, only: string_pair_input_t
        use iso_varying_string, only: operator(//), operator(<=), char
        use vegetables, only: input_t, result_t, assert_that, fail
    ...
    pure function check_string_less_than_equal_character(strings) result(result_)
        use custom_generator, only: string_pair_input_t
        use iso_varying_string, only: operator(//), operator(<=), char
        use vegetables, only: input_t, result_t, assert_that, fail
